...
class wowza (
  ...
  $enable_ssl            = $wowza::params::enable_ssl,
  $ssl_port              = $wowza::params::ssl_port,
  $ssl_stream_name       = $wowza::params::ssl_stream_name,
  $ssl_keystore_path     = $wowza::params::ssl_keystore_path,
  $ssl_keystore_password = $wowza::params::ssl_keystore_password,
